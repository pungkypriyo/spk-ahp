<nav class="navbar navbar-expand-sm navbar-default">
   ...
   <div id="main-menu" class="main-menu collapse navbar-collapse">
         <ul class="nav navbar-nav">
            ...
            <li class="active"> <a href="<?=base_url();?>"> <i class="menu-icon fa fa-file"></i>Data Kain </a> </li>
            <li class="active"> <a href="<?=base_url();?>"> <i class="menu-icon fa fa-random"></i>Compare Kain </a> </li>
