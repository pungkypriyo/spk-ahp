        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#"> <i class="menu-icon fa fa-table"></i>Perhitungan </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Pilih Data Motif</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="perbandingan-kriteria.php" class="btn btn-success"><i class="ti-angle-right"></i>&nbsp; Selanjutnya</a>
                            </div>
                        </div>
                    </div>
